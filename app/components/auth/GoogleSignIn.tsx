...
export function GoogleSignIn({
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Call signIn with Google provider - no additional params needed
      // redirectTo is handled automatically by the auth system
      await signIn('google');
    } catch (err) {
      console.error('Google sign-in error:', err);
      const authError = await handleError(err, 'google-signin');
